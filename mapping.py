...
# Define the dictionaries as provided
MODEL_NAME_MAP = {
...
# Collect all mappings into a DataFrame
rows = []
for map_name, mapping in [
    ('MODEL_NAME_MAP', MODEL_NAME_MAP),
    ('AGENT_NAME_MAP', AGENT_NAME_MAP),
    ('AGENT_NAME_SHORT_MAP', AGENT_NAME_SHORT_MAP)
]:
    for key, value in mapping.items():
        rows.append({'map_name': map_name, 'key': key, 'value': value})

df = pd.DataFrame(rows)

# Save to CSV
output_csv = 'hal_name_map.csv'
